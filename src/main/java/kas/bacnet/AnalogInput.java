...
public class AnalogInput extends Point {
    private final float presentValue;
    private AnalogInputObject obj;

    public AnalogInput(LocalDevice localDevice, int instanceNumber, String name, boolean outOfService,
